...
local function openPage(pageIdx, title, script)
    ...
    inavsuite.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.audio)@" .. " / " .. "@i18n(app.modules.settings.txt_audio_switches)@")
    ...
    for i, v in ipairs(sensorList) do
        ...
        inavsuite.app.formFields[formFieldCount] = form.addSwitchField(inavsuite.app.formLines[inavsuite.app.formLineCnt], nil, function()
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(config) do inavsuite.preferences.switches[key] = value end
