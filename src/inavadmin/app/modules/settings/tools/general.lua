...
local function openPage(pageIdx, title, script)
    ...
    inavsuite.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.txt_general)@")
    ...
    inavsuite.app.formLines[inavsuite.app.formLineCnt] = form.addLine("@i18n(app.modules.settings.txt_iconsize)@")
    inavsuite.app.formFields[formFieldCount] = form.addChoiceField(inavsuite.app.formLines[inavsuite.app.formLineCnt], nil, {{"@i18n(app.modules.settings.txt_text)@", 0}, {"@i18n(app.modules.settings.txt_small)@", 1}, {"@i18n(app.modules.settings.txt_large)@", 2}}, function() return config.iconsize ~= nil and config.iconsize or 1 end, function(newValue) config.iconsize = newValue end)

    formFieldCount = formFieldCount + 1
    inavsuite.app.formLineCnt = inavsuite.app.formLineCnt + 1
    inavsuite.app.formLines[inavsuite.app.formLineCnt] = form.addLine("@i18n(app.modules.settings.txt_hs_loader)@")
    ...
    formFieldCount = formFieldCount + 1
    inavsuite.app.formLineCnt = inavsuite.app.formLineCnt + 1
    inavsuite.app.formLines[inavsuite.app.formLineCnt] = form.addLine("@i18n(app.modules.settings.txt_syncname)@")
    inavsuite.app.formFields[formFieldCount] = form.addBooleanField(inavsuite.app.formLines[inavsuite.app.formLineCnt], nil, function() return config.syncname or false end, function(newValue) config.syncname = newValue end)

    formFieldCount = formFieldCount + 1
    inavsuite.app.formLineCnt = inavsuite.app.formLineCnt + 1
    inavsuite.app.formLines[inavsuite.app.formLineCnt] = form.addLine("@i18n(app.modules.settings.txt_batttype)@")
    ...
    inavsuite.app.formFields[formFieldCount] = form.addChoiceField(inavsuite.app.formLines[inavsuite.app.formLineCnt], nil, txbattChoices, function() return config.txbatt_type ~= nil and config.txbatt_type or 0 end, function(newValue)
        config.txbatt_type = newValue
        if inavsuite.preferences and inavsuite.preferences.general then inavsuite.preferences.general.txbatt_type = newValue end
    end)

    for i, field in ipairs(inavsuite.app.formFields) do if field and field.enable then field:enable(true) end end
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(config) do inavsuite.preferences.general[key] = value end
