...
local function openPage(pidx, title, script)
    ...
    for i in pairs(inavsuite.app.gfx_buttons) do if i ~= "settings_dashboard_audio" then inavsuite.app.gfx_buttons[i] = nil end end
    ...
    inavsuite.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.audio)@")
