# Inav INAVADMIN Sensor Updater

This folder contains the Python GUI script and build tools for generating a standalone Windows executable for updating simulated sensor values used in Inav INAVADMIN testing.
...
**Example:**
```bat
set FRSKY_INAVADMIN_GIT_SRC=C:\GitHub\rotorflight-lua-ethos-suite
...
## 📄 License
This project is part of Inav INAVADMIN. For licensing details, refer to the upstream repository.
