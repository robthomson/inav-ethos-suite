...
# Require config path from INAVADMIN_CONFIG env var
CONFIG_PATH = os.environ.get('INAVADMIN_CONFIG')

if not CONFIG_PATH:
    print("[CONFIG ERROR] Environment variable INAVADMIN_CONFIG is not set.")
    sys.exit(1)
